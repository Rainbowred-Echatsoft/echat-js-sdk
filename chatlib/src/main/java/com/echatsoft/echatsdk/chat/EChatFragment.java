package com.echatsoft.echatsdk.chat;
...
import com.echatsoft.echatsdk.chat.otherui.BrowserActivity;
import com.echatsoft.echatsdk.chat.utils.Constants;
import com.echatsoft.echatsdk.chat.utils.FragmentUtils;
import com.echatsoft.echatsdk.chat.utils.GifSizeFilter;
import com.echatsoft.echatsdk.chat.utils.GlideImageEngine;
import com.echatsoft.echatsdk.chat.utils.JZMediaIjkplayer;
import com.echatsoft.echatsdk.chat.utils.RequestUtils;
import com.echatsoft.echatsdk.chat.utils.UrlUtils;
...
import com.echatsoft.echatsdk.chat.otherui.CameraActivity;
import com.echatsoft.echatsdk.chat.otherui.CustomVideoPlayerStandard;
import com.echatsoft.echatsdk.chat.otherui.ListDialog;
import com.echatsoft.echatsdk.chat.otherui.WebviewBottomDialogActivity;
...
import static com.echatsoft.echatsdk.chat.utils.EChatUtils.sendLastChatInformation;
...
public class EChatFragment extends Fragment implements Toolbar.OnMenuItemClickListener, FragmentUtils.OnBackClickListener {
    ...
    private void initData(Bundle bundle) {
        ...
        //用户点击打开
            ...
            openCompanyId = bundle.getString(Constants.COMPANY_ID, bundle.getString(Constants.EXTRA_COMPANY_ID, ""));
            pushInfo = bundle.getString(Constants.PUSH_INFO);
            metaData = bundle.getString(Constants.METADATA);
            visEvt = bundle.getString(Constants.VISEVT);
            echatTag = bundle.getString(Constants.ECHATTAG);
            routeEntranceId = bundle.getString(Constants.ROUTEENTRANCEID);
            String type = bundle.getString(Constants.TYPE);
            LogUtils.i(String.format("visEvt:%s ", visEvt));
            if (Constants.TYPE_CHAT.equals(type)) {
    ...
    private void initBaseUI(Bundle savedInstanceState) {
        ...
        //debug
        //添加一个名叫 openUrl的菜单按钮
        toolbar.getMenu().add(1, 1001, 1, "openEChatUrl");
        toolbar.getMenu().add(1, 1002, 1, "openBilibiliUrl");
        toolbar.getMenu().add(1, 1003, 1, "openTestUrl");
    ...
    public boolean onMenuItemClick(MenuItem menuItem) {
        if (menuItem.getItemId() == R.id.endChat) {
            ...
            loadUrl("https://qjl.echatsoftuat.com/visitor/touchtest.html");
        }
        return true;
    }
...
//        }, 5000);
    ...
    private void sendNewMessage(String chatUrl, String companyIdString, String companyName, String msgContent, int unreadMsgCount, int newMsgType) {
        if (!TextUtils.isEmpty(msgContent) || !TextUtils.isEmpty(companyName)) {
            ...
            bundle.putInt(Constants.CHAT_LOCAL_UNREAD_COUNT, unreadMsgCount);
