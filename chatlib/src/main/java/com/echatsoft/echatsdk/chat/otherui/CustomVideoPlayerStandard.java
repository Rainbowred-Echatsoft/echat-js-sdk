        ...
        if (v.getId() == R.id.surface_container) {
            ...
            if (motionEvent.getAction() == MotionEvent.ACTION_DOWN) {
                ...
                if (isLongClickModule && !isLongClicking) {
                    ...
                    try {
                        intent.putExtra(Constants.EXTRA_VIDEO_URL, String.valueOf(jzDataSource.urlsMap.get(JZDataSource.URL_KEY_DEFAULT)));
                        intent.putExtra(Constants.EXTRA_VIDEO_FILE_NAME, String.valueOf(jzDataSource.objects[0]));
                    } catch (Exception e) {
                    }
