...
import com.echatsoft.echatsdk.chat.utils.aes.AesUtils;
...
public class EChatUtils {
    ...
    public static void getUnreadCount(@NonNull Context context,
        ...
        RequestUtils.getInstance(context).requestAsyn(
                Constants.GET_UNREAD_COUNT_APIURL,
                RequestUtils.TYPE_GET,
    ...
    public static void sendLastChatInformation(Context context, String content, long lastChatTime) {
        ...
        bundle.putString(Constants.NOTIFICATION_LAST_CONTENT, content);
        bundle.putLong(Constants.NOTIFICATION_LAST_CHAT_TIME, lastChatTime);
    ...
    public static void sendRemoteUnreadCount(Context context, int count, long echatTimeStamp) {
        ...
        Intent intent = new Intent();
        Bundle bundle = new Bundle();
        bundle.putInt(Constants.CHAT_REMOTE_UNREAD_COUNT, count);
        bundle.putLong(Constants.NOTIFICATION_LAST_CHAT_TIME, echatTimeStamp);
        intent.putExtras(bundle);
    ...
    public static void sendLocalUnreadCount(Context context, int localUnreadCount, long lastChatTime) {
        ...
        Intent intent = new Intent();
        Bundle bundle = new Bundle();
        bundle.putInt(Constants.CHAT_LOCAL_UNREAD_COUNT, localUnreadCount);
        bundle.putLong(Constants.NOTIFICATION_LAST_CHAT_TIME, lastChatTime);
        intent.putExtras(bundle);
    ...
    public static void setLocalUnreadCount(int count) {
        SPUtils.getInstance().put(Constants.CHAT_LOCAL_UNREAD_COUNT, count);
    }
