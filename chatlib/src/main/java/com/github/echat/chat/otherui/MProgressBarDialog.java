...
public class MProgressBarDialog {
    ...
    private void initDialog() {
        ...
        try {
            ...
            View mProgressDialogView = inflater.inflate(com.maning.mndialoglibrary.R.layout.mn_progress_bar_dialog_layout, null);
            mDialog = new Dialog(mContext, com.maning.mndialoglibrary.R.style.MNCustomDialog);
            mDialog.setCancelable(mBuilder.cancel);
            mDialog.setCanceledOnTouchOutside(mBuilder.cancel);
            if (mBuilder.cancelListener != null) {
                mDialog.setOnCancelListener(mBuilder.cancelListener);
            }
            ...
            //获取布局
            dialog_window_background = mProgressDialogView.findViewById(com.maning.mndialoglibrary.R.id.dialog_window_background);
            dialog_view_bg = mProgressDialogView.findViewById(com.maning.mndialoglibrary.R.id.dialog_view_bg);
            tvShow = mProgressDialogView.findViewById(com.maning.mndialoglibrary.R.id.tvShow);
            horizontalProgressBar = mProgressDialogView.findViewById(com.maning.mndialoglibrary.R.id.horizontalProgressBar);
            circularProgressBar = mProgressDialogView.findViewById(com.maning.mndialoglibrary.R.id.circularProgressBar);
    ...
    public static final class Builder {
        ...
        public Builder(Context context) {
            mContext = context;
            //默认配置
            backgroundWindowColor = mContext.getResources().getColor(com.maning.mndialoglibrary.R.color.mn_colorDialogWindowBg);
            backgroundViewColor = mContext.getResources().getColor(com.maning.mndialoglibrary.R.color.mn_colorDialogViewBg);
            strokeColor = mContext.getResources().getColor(com.maning.mndialoglibrary.R.color.mn_colorDialogTrans);
            textColor = mContext.getResources().getColor(com.maning.mndialoglibrary.R.color.mn_colorDialogTextColor);
            cornerRadius = 6;
            strokeWidth = 0;
            progressbarBackgroundColor = mContext.getResources().getColor(com.maning.mndialoglibrary.R.color.mn_colorDialogProgressBarBgColor);
            progressColor = mContext.getResources().getColor(com.maning.mndialoglibrary.R.color.mn_colorDialogProgressBarProgressColor);
        ...
        public Builder setCancelDialog(boolean flag) {
            this.cancel = cancel;
            return this;
        }
