 ...
 */
public class EChatBottomSheetDialog extends AppCompatDialog {
    ...
    public EChatBottomSheetDialog(@NonNull Context context) {
        this(context, 0);
    }

    public EChatBottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
    ...
    protected EChatBottomSheetDialog(@NonNull Context context, boolean cancelable,
    ...
    private View wrapInBottomSheet(int layoutResId, View view, ViewGroup.LayoutParams params) {
        container = (FrameLayout) View.inflate(getContext(),
                R.layout.layout_design_bottom_sheet_dialog_echat, null);
