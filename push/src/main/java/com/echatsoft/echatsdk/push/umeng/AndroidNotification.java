...
abstract class AndroidNotification extends BaseNotification {
    ...
    // Keys can be set in the body level
    protected static final HashSet<String> CHANNEL_KEYS = new HashSet<>(Arrays.asList(
            "channel_activity", "xiaomi_channel_id", "vivo_classification",
            "oppo_channel_id", "main_activity", "huawei_channel_importance",
    ...
    public boolean setPredefinedKeyValue(String key, Object value) throws Exception {
        if (ROOT_KEYS.contains(key)) {
            ...
            if (key.equals("payload") || key.equals("body") || key.equals("policy") || key.equals("extra") || key.equals("channel_properties")) {
    ...
    public void setChannelActivity(String activityName) throws Exception {
        setPredefinedKeyValue("channel_activity", activityName);
    }

    public void setChannelXiaomiId(String xiaomiId) throws Exception {
        setPredefinedKeyValue("xiaomi_channel_id", xiaomiId);
    }
